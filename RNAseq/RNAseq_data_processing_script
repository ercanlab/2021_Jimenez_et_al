...
c_elegans_annots <- getCelegansAnnotations("WS220_gene_annotations_WormMart_unique.xlsx")
annot<-read.table("c.elegans.WS220.gene.wbid.chr.start.stop.txt",header=T)
tannot<-annot
